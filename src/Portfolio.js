...
export default function Portfolio() {
 ...
 const formRef = useRef();
  const [status, setStatus] = useState(""); // pour afficher message succès/erreur

  const sendEmail = (e) => {
    e.preventDefault();

    emailjs.sendForm(
      "YOUR_SERVICE_ID",      // ton service EmailJS
      "YOUR_TEMPLATE_ID",     // ton template EmailJS
      formRef.current,
      "YOUR_PUBLIC_KEY"       // ton public key EmailJS
    )
    .then(
      (result) => {
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-[#020617] to-[#040414] text-gray-100 font-sans">
          ...
          <nav className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#6EE7F7] to-[#7C3AED] shadow-xl flex items-center justify-center ring-1 ring-white/5">
                <span className="font-extrabold tracking-tight text-lg text-transparent bg-clip-text bg-gradient-to-r from-white to-[#7C3AED]">JD</span>
              </div>
              <div>
                <h1 className="text-xl font-semibold">JEREMIE LANDRY DJOKO</h1>
                <p className="text-sm text-white/60"> Analyste Cyber-sécurité • Blue Team & Red Team • Dév Web </p>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a href="#experience" className="hover:text-white/90">Expériences</a>
              <a href="#contact" className="hover:text-white/90">Contact</a>
            </div>

            <div className="md:hidden">
              <button className="px-3 py-2 ring-1 ring-white/10 rounded-md">Menu</button>
            </div>
          </nav>
        </header>
        ...
        <main className="max-w-6xl mx-auto px-6 pb-24">
          {/* Hero Section */}
          <section id="hero" className="grid md:grid-cols-2 gap-8 items-center mt-8">
            <div className="space-y-6">
              ...
              <p className="text-lg text-white/75">
                Je suis diplômé en licence de  Sécurité Informatique (IFRI-UAC, 2025). Passionné par la Cyber-sécurité & l'IA, l'administration réseau et le développement d'outils d'analyse. Je conçois des solutions pratiques et robustes pour sécuriser les systèmes et réseaux et pour facilité la vie au quotidien.
              </p>

              <div className="flex gap-4">
                <a href="#projects" className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-[#0f1724]/60 ring-1 ring-[#6EE7F7]/20 hover:scale-[1.02] transition">Voir mes projets</a>
                <a href="/JEREMIE-LANDRY-DJOKO-CV.pdf" download className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-[#7C3AED] text-black font-semibold hover:brightness-110 transition">Télécharger CV</a>
              </div>

              <div className="mt-4 text-sm text-white/60">
                <span className="block">📍 Abomey-Calavi, Bénin</span>
                <span className="block">✉️ <a href="mailto:jeremiedjoko@gmail.com" className="underline">jeremiedjoko@gmail.com</a> • 📞 (+229) 46 94 16 09</span>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative p-6 rounded-2xl ring-1 ring-white/6">
                <div className="bg-[#061728] p-4 rounded-lg border border-white/5">
                  ...
                  <h4 className="font-bold text-lg mt-2">Système de détection & prévention d'exfiltration (Port Autonome de Cotonou)</h4>
                  <p className="mt-2 text-sm text-white/70">
                    Conception d'une solution basée sur Suricata et routeur Linux pour détecter les exfiltrations DNS/HTTP, mise en place d'une stratégie IDS/IPS et d'un workflow alert-to-action.
                  </p>
		    ...
		    <span className="py-1 px-2 rounded-md bg-white/4">ELK Stack</span>
                ...
                <div className="mt-4 flex gap-3">
                  <a href="#contact" className="text-sm px-3 py-2 rounded-md bg-[#0f1724]/60 ring-1 ring-[#6EE7F7]/20">Me contacter</a>
                  <a href="#projects" className="text-sm px-3 py-2 rounded-md bg-[#7C3AED] text-black">Voir plus</a>
                </div>
              </div>
            </div>
          </section>
          ...
          {/* About Section */}
          <section id="about" className="mt-16 p-6 rounded-2xl bg-gradient-to-br from-[#021024]/40 to-transparent ring-1 ring-white/6">
            <h3 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#6EE7F7] to-[#7C3AED]">À propos</h3>
            <p className="mt-4 text-white/70">
              Titulaire d'une licence professionelle en sécurité informatique avec une solide formation théorique (IFRI-UAC, Licence, 2025) et une expérience pratique acquise lors de stages, de traveaux pratiques ou de Labs. Je maîtrise l'administration réseau, l'analyse de trafic, la configuration d'IDS/IPS et le développement d'outils en Python et Bash, L'OSINT, La veille tecnologique et Le develpppement web. Mon objectif : concevoir des solutions réelles pour protéger les infrastructures critiques.
            </p>

            <div className="mt-6 grid md:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg bg-[#071025]/60 ring-1 ring-white/4">
                <h4 className="font-semibold">Formation</h4>
                <p className="text-sm text-white/60 mt-2">Licence en Sécurité Informatique — IFRI-UAC (2025)</p>
              </div>
              <div className="p-4 rounded-lg bg-[#071025]/60 ring-1 ring-white/4">
                <h4 className="font-semibold">Langages</h4>
                <p className="text-sm text-white/60 mt-2">Python, Bash, C++, HTML, CSS, PHP, SQL</p>
              </div>
              <div className="p-4 rounded-lg bg-[#071025]/60 ring-1 ring-white/4">
                <h4 className="font-semibold">Outils & OS</h4>
                <p className="text-sm text-white/60 mt-2">Wireshark, Metasploit, Suricata, BurpSuite, Nmap, Snort, FortiGate, React Js, Python / Flask, MySQL, Bootstrap, Git / GitHub  Linux, Windows</p>
              </div>
            </div>
          </section>
          ...
          <section id="projects" className="mt-12">
            <div className="flex items-center justify-between">
              <h3 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#6EE7F7] to-[#7C3AED]">Projets</h3>
            ...
            <div className="mt-6 grid md:grid-cols-2 gap-6">
              ...
              <article className="p-5 rounded-xl bg-[#061328]/60 ring-1 ring-white/6 backdrop-blur-md transform hover:scale-[1.01] transition">
                <h4 className="font-semibold text-lg">Système de détection & prévention d'exfiltration</h4>
                <p className="text-sm text-white/70 mt-2">
                  Conception et prototype pour le Port Autonome de Cotonou : détection d'exfiltration via DNS/HTTP, règles Suricata personnalisées, workflow alert-to-action et tableau de bord de monitoring.
                </p>
              ...
              {/* Card 2 */}
              <article className="p-5 rounded-xl bg-[#061328]/60 ring-1 ring-white/6 backdrop-blur-md transform hover:scale-[1.01] transition">
                <h4 className="font-semibold text-lg">Application mobile - Dashboard & Notifications</h4>
                <p className="text-sm text-white/70 mt-2">
                  Prototype d'application mobile (Flutter) pour recevoir des alertes via FCM, afficher un tableau de bord des incidents et exporter des rapports PDF.
                </p>
                <ul className="mt-3 text-sm text-white/60 list-disc list-inside">
              ...
              <article className="p-5 rounded-xl bg-[#061328]/60 ring-1 ring-white/6 backdrop-blur-md transform hover:scale-[1.01] transition">
                ...
                <p className="text-sm text-white/70 mt-2">
                  Analyse et détection de scripts d'exfiltration sur DNS/HTTP. Développement de règles de détection et playbooks pour bloquer les canaux cachés.
                </p>
                <ul className="mt-3 text-sm text-white/60 list-disc list-inside">
              ...
              <article className="p-5 rounded-xl bg-[#061328]/60 ring-1 ring-white/6 backdrop-blur-md transform hover:scale-[1.01] transition">
                ...
                <p className="text-sm text-white/70 mt-2">
                  Mise en place d'un FortiGate (logique) pour filtrer l'accès aux sites sur le réseau du Ministère de l'Agriculture : journaux, règles et segmentation simple.
                </p>
                <div className="mt-4 flex gap-3">
...
<article className="p-5 rounded-xl bg-[#061328]/60 ring-1 ring-white/6 backdrop-blur-md transform hover:scale-[1.01] transition">
  ...
  <p className="text-sm text-white/70 mt-2">
    Application web de covoiturage développée avec Flask. Permet aux utilisateurs de proposer ou rechercher des trajets et reçoit des suggestions de correspondance automatiquement.
  </p>
  <ul className="mt-3 text-sm text-white/60 list-disc list-inside">
...
<article className="p-5 rounded-xl bg-[#061328]/60 ring-1 ring-white/6 backdrop-blur-md transform hover:scale-[1.01] transition">
  ...
  <p className="text-sm text-white/70 mt-2">
    Développement et entraînement d’un modèle d’intelligence artificielle pour détecter les exfiltrations de données sur des canaux cachés (DNS/HTTP). Permet de générer des alertes en temps réel et d’analyser le trafic réseau.
  </p>
  <ul className="mt-3 text-sm text-white/60 list-disc list-inside">
  ...
  <div className="mt-4 flex gap-3">
   ...
   <div>
      <form 
        ref={formRef} 
        onSubmit={sendEmail} 
        className="p-4 rounded-lg bg-[#071025]/60 ring-1 ring-white/6">
        <label className="block text-sm text-white/70">Nom</label
	>
        <input name="user_name" className="mt-2 w-full p-2 rounded-md bg-transparent ring-1 ring-white/6" placeholder="Ton nom" />

        <label className="block text-sm text-white/70 mt-3">Email</label>
        <input name="user_email" className="mt-2 w-full p-2 rounded-md bg-transparent ring-1 ring-white/6" placeholder="ton@email.com" />

        <label className="block text-sm text-white/70 mt-3">Message</label>
        <textarea name="message" className="mt-2 w-full p-2 rounded-md bg-transparent ring-1 ring-white/6" rows={4} placeholder="Écris ton message..." />
